...
import de.uni_hamburg.informatik.swt.se2.kino.bezahl.BezahlWerkzeug;
...
public class PlatzVerkaufsWerkzeug
{
    ...
    private void verkaufePlaetze(Vorstellung vorstellung)
    {
        ...
        _bezahlwerkzeug = new BezahlWerkzeug(_vorstellung.getPreisFuerPlaetze(plaetze));
        ...
        _bezahlwerkzeug.setUndzeigFenster();
        //TODO wichtige Stelle, verkauf verhalten in inner klasse packen
        aktualisierePlatzplan();
    }
