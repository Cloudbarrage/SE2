...
public class VorstellungsAuswaehlWerkzeug extends ObservableSubWerkzeug
{
    ...
    private void vorstellungWurdeAusgewaehlt()
    {
        ...
        //TODO informierueberaendrung zur Kassenwerkzeug weitergeben
    }
    ...
    public Vorstellung getAusgewaehlteVorstellung()
    {
        ...
        VorstellungsFormatierer adapter = (VorstellungsFormatierer) _ui.getVorstellungAuswahlList()
            .getSelectedValue();
        if (adapter != null)
        {
     ...
     */
    public void setTagesplan(Tagesplan tagesplan) //TODO wichtige stelle, mit Kassenwerkzeug Klasse zu tun
    {
