...
public class TagesplanTest
{
    ...
    private static final Vorstellung _vorstellung = new Vorstellung(_kinosaal, //TODO
            _film, _startzeit, _endzeit, _datum, Geldbetrag.valueOf(0,0));
    private static final Vorstellung _vorstellung2 = new Vorstellung(_kinosaal,
            _film, _startzeit2, _endzeit, _datum, Geldbetrag.valueOf(0,0));
    private static final Vorstellung _vorstellung3 = new Vorstellung(
            _kinosaal2, _film, _startzeit2, _endzeit, _datum, Geldbetrag.valueOf(0,0));
