...
import de.uni_hamburg.informatik.swt.se2.kino.werkzeuge.bezahlansicht.BezahlWerkzeug;
...
public class PlatzVerkaufsWerkzeug implements SubwerkzeugObserver
{
    ...
    {
        _bezahlwerkzeug = new BezahlWerkzeug(_vorstellung, _ui.getPlatzplan().getAusgewaehltePlaetze()); 
        _bezahlwerkzeug.registriereBeobachter(this);
        _bezahlwerkzeug.getBezahlWerkzeugUI().macheBezahlansichtSichtbar();
    }
