...
public class ModellTest
{
    ...
    @Test
    public void AufrufTestTyp4()
    {
        // Erzeuge mehrere Beobachter und Beobachtbare
        BeobachtbarVier beobachtbar1 = new BeobachtbarVier();
        BeobachtbarVier beobachtbar2 = new BeobachtbarVier();
        BeobachterVier beobachter1 = new BeobachterVier();
        BeobachterVier beobachter2 = new BeobachterVier();
        beobachter1.registriereBeobachter(beobachtbar1);
        beobachter1.registriereBeobachter(beobachtbar2);
        beobachter2.registriereBeobachter(beobachtbar1);
        beobachter2.registriereBeobachter(beobachtbar2);
        ...
        // Prüfe, ob alle Änderungen angekommen sind
        assertEquals(beobachtbar1.getNumber(), beobachter1.getNumber(beobachtbar1));
        assertEquals(beobachtbar1.getNumber(), beobachter2.getNumber(beobachtbar1));
        assertEquals(beobachtbar2.getNumber(), beobachter1.getNumber(beobachtbar2));
        assertEquals(beobachtbar2.getNumber(), beobachter2.getNumber(beobachtbar2));
    }
